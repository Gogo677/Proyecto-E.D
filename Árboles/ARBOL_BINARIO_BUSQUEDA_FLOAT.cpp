...
Nodo* crearNodo(float id, char* n); 
Nodo* buscar (Nodo* p, float matricula); 
void insertar (Nodo** raiz, float matricula, char* nombre); 
void reemplazar(Nodo** act); 
void eliminar (Nodo** raiz, float matricula); 
void visualizar (Nodo* r, float x, float y); 
...
Nodo* buscar (Nodo* raiz, float matricula) 
{ 
      float encontrado = 0; 
...
* 
*/ 
void eliminar (Nodo** r, float matricula) 
{ 
     if (!(*r)) 
